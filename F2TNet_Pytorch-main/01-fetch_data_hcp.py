...
data_folder = '/data/hzb/project/Brain_Predict_Score/ViTPre0219/F2TNet_Pytorch-main/data_hcp/HCP_pcp/Gordon/filt_noglobal/'

if not os.path.exists(data_folder):
    os.makedirs(data_folder)
shutil.copyfile(os.path.join('data_hcp','subject_ID.txt'), os.path.join(data_folder, 'subject_IDs.txt'))
...
def main():
    ...
    parser.add_argument('--pipeline', default='cpac', type=str,
                        help='Pipeline to preprocess ABIDE data. Available options are ccs, cpac, dparsf and niak.'
                             ' default: cpac.')
    parser.add_argument('--atlas', default='Gordon333',
    ...
    # if download == True:
    #     abide = datasets.fetch_abide_pcp(data_dir='data', pipeline=pipeline,
