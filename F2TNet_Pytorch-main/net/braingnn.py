...
class Network_regress(torch.nn.Module):
    def __init__(self, indim, ratio, nclass, k=8, R=200):
        '''
        ...
        :param R: (int) number of ROIs
        '''
        super(Network_regress, self).__init__()
...
class Network_regress_score(torch.nn.Module):
    def __init__(self, indim, ratio, nclass, k=8, R=200):
        '''
        ...
        :param R: (int) number of ROIs
        '''
        super(Network_regress_score, self).__init__()
        ...
        self.fc2 = torch.nn.Linear(self.dim2, self.dim3)
        self.bn2 = torch.nn.BatchNorm1d(self.dim3)
        # self.sof = torch.nn.Softmax()

        self.fc3 = torch.nn.Linear(self.dim3, nclass)
        self.fc4 = torch.nn.Linear( nclass, 1)
...
class Network_regress_score_CNN(torch.nn.Module):
    def __init__(self, indim, outdim):
        ...
        :param R: (int) number of ROIs
        '''
        super(Network_regress_score_CNN, self).__init__()
        ...
        self.fc1 = nn.Linear(self.indim, self.dim1)
        self.bn1 = torch.nn.BatchNorm1d(self.dim1)

        self.fc2 = nn.Linear(self.dim1, self.dim2)
        self.bn2 = torch.nn.BatchNorm1d(self.dim2)

        self.fc3 = nn.Linear(self.dim2, self.dim3)
        self.bn3 = torch.nn.BatchNorm1d(self.dim3)


        self.fc4 = nn.Linear(self.dim3, self.dim4)
